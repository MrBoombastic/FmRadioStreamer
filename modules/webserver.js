    ...
    constructor() {
        this.run = async function () {
                    ...
                    .then(result => {
                        ...
                        ytdl.getInfo(music.id, (err) => {
                            ...
                            video.on('end', () => {
                                ...
                                //Why FFmpeg produces data on stderr? idk
                                ...
                                ffmpegProgress.on('exit', function (code) {
                                    ...
                                    if (code !== 0) {console.log("FFmpeg returned error:" + code); return res.send("FFmpeg error!");}
            ...
            app.get(prefix + "change/:setting/:value", (req, res) => {
                ...
                else {helpers.save(setting, value);res.send(setting.toString() + ", " + value.toString());}
            })
            /*
